        ...
        <div className="mt-6 space-y-4">
          ...
          >
           ...
           >
             ...
             <span className="text-sm opacity-90">{t('login.dummyElectronicId')}</span>
           </button>
           ...
           >
             <span>{t('login.automatedTestLogin')}</span>
             <span className="text-sm opacity-90">{t('login.emailPasswordTests')}</span>
           </button>
           ...
           {showDummyLogin && (
             <div className="space-y-3">
               ...
               >
                 {isLoading ? t('login.loggingIn') : t('login.loginWithPhone')}
               </button>
             </div>
           )}
